                        ...
                        <form method="post" action="{{route('category.update',$Category)}}">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input name="title" value="{{$Category->title}}" type="text" class="form-control" id="exampleInputEmail1" placeholder="عنوان">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control">
                                        ...
                                        <option value="disabled"> لطفا دسته بندی را انتخاب کنید </option>
                                        ...
                                        <option
                                            ...
                                            id="{{$parent->id}}"> {{$parent->title}}</option>
                                        @endforeach
