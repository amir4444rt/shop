            ...
            <ul class="nav navbar-nav">
                ...
                <li class="mega-menu dropdown"><a>دسته ها</a>
                    <div class="dropdown-menu">
                        ...
                        <div class="column col-lg-2 col-md-3"><a href="category.html">{{$cats->title}}</a>
                            <div>
                                <ul>

                                    @foreach($cats->children as $child_cat)

                                    <li><a href="category.html">{{$child_cat->title}} @if($child_cat->children->count() > 0) <span>&rsaquo;</span> @endif</a>

                                        @if($child_cat->children->count() > 0)

                                            <div class="dropdown-menu">

                                                <ul>

                                                    @foreach($child_cat->children as $sub_child)

                                                        <li><a>{{$sub_child->title}}</a></li>
